					...
					<div class="card">
						...
						<div class="card-body">
							...
							<div class="col-12">
								...
								<c:if test="${p.product_Stock < 5 }">
									<p class="card-text">
										Stock:<span class="mytext"> Only ${p.product_Stock}
											Available</span>
									</p>
								</c:if>
							</div>
							...
							<div class="row">
								<div class="col-6">
									<a href="${cr2}/addtocart?product_Id=${pid.product_Id}" class="btn btn-success">Add to cart</a>
								</div>
								<div class="col-6">
									<a href="${cr2}/oneproduct?product_Id=${pid.product_Id}" class="btn btn-warning">View Details</a>
								</div>
							</div>
						</div>
					</div>
